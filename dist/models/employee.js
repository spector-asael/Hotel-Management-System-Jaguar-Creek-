...
// models/Guest.ts
const employeeinterface_1 = __importDefault(require("../interfaces/employeeinterface"));
const config_1 = __importDefault(require("../db/config"));
class Employee extends employeeinterface_1.default {
    ...
    static findByUsername(username) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return new Employee(row.user_id, row.user_first_name, row.user_last_name, row.user_phone_number, row.username, row.user_password, row.user_email);
            }
            catch (err) {
